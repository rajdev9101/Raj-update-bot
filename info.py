...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002441285313')]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'raj_dev_01') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'shortlinks.com')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'dbf9516e171738e9f470082216dd')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://envs.sh/v_r.jpg')
...
TUTORIAL = environ.get('TUTORIAL', '@Doraemonraj_bot') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
